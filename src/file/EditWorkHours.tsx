...
const EditWorkHours: React.FC = () => {
  ...
  // Find the work hour entry to edit
  ...
  // Transform the workHour for the form
  const initialData: WorkHourFormData = {
    startDate: workHour.startDate,
    endDate: workHour.endDate,
    startTime: workHour.startTime,
    endTime: workHour.endTime,
    heading: typeof workHour.heading === 'string' ? workHour.heading : workHour.heading._id,
  };
